...
4. Integration hooks for heartbeat preflight/postflight
...
CLI (via script wrapper):
    python3 scripts/hooks/obligation_tracker.py check
    python3 scripts/hooks/obligation_tracker.py status
"""
