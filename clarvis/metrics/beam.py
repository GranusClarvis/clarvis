...
BEAM_TASKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "gold_answer": ["cookie", "session", "gmail"],
        "gold_evidence": "Browser credentials (REDACTED_EMAIL) stored only in browser session cookies (data/browser_sessions/default_session.json), NOT in OpenClaw credentials dir.",
        "collections": ["clarvis-infrastructure", "clarvis-learnings"],
        "difficulty": "hard",
        "context_length_bucket": "medium",
    },
