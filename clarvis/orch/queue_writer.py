...
management. Complements queue_engine.py (runtime state machine) by owning
the human/automated task creation side.

Migrated from scripts/queue_writer.py (2026-04-04 spine consolidation).

Usage:
    from clarvis.orch.queue_writer import add_task, add_tasks
