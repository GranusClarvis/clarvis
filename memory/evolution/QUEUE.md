...
- [x] **[CODE_GEN_FAILURE_MODE_HISTOGRAM]** Shipped 2026-05-12: `scripts/audit/code_gen_failure_histogram.py` classifies 414 code-gen episodes (last 30d) into 7 buckets. Top-3: `other`=59 (mostly classifier-misclassified, covered by in-flight `[ESR_CLASSIFIER_MISCLASSIFIED_FIX]`), `incomplete_implementation`=10, `lint_fail`=4. Each has ≥2 example IDs and a concrete fix recommendation (`[CODE_GEN_INCOMPLETE_TAG_FIX]`, `[CODE_GEN_LINT_DECOUPLE_FIX]`). Outputs: `data/audit/code_gen_failures_2026-05-12.json`, `docs/internal/audits/CODE_GEN_FAILURE_HISTOGRAM_2026-05-12.md`. (PROJECT:CLARVIS)
