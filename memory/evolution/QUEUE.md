...
## P1 — This Week
- [ ] [ABSOLUTE_ZERO 2026-02-24] [AZR] Self-improvement: AZR cycle found capability gap (avg_learnability=0.51). Insights: Outcome prediction calibrated for this task type (learnability=0.67). Duration p; Prediction miscalibration: predicted 'soft_failure' but actual was 'success'. Le. Investigate and address the weakest prediction/diagnosis area.
- [ ] [EPISODIC_SYNTHESIS 2026-02-24] Investigate and fix: Fix module import reliability
...
- [ ] Build attention-guided memory consolidation — extend memory_consolidation.py to use attention spotlight salience when deciding what to prune. High-salience memories should resist decay. Low-salience + low-access + old = prune candidate.
...
- [ ] P3: Global Workspace — VanRullen/Kanai + Dossa 2024 (deeper dive beyond Phase 1)
- [ ] P4: Darwin Gödel Machine — Sakana AI 2025
- [ ] P5: Bayesian brain hypothesis — Lake, Tenenbaum
- [ ] P6: Judea Pearl — Causal Inference & structural causal models
- [ ] P7: Absolute Zero Reasoner — self-improvement through autonomous task generation
