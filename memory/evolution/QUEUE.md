...
- [x] **[BB_PHASE2_HALMOS_COMMITUSED_PROOF]** SHIPPED 2026-05-04 in `agents/mega-house` repo: `packages/contracts/test/BunnyBagzCoinflipHalmos.t.sol` with three `check_*` symbolic tests (direct replay, replay-across-settle, commitUsed monotonicity); halmos==0.3.3 wired into `.github/workflows/ci.yml` as new `halmos` job; local run green: 3 passed; 0 failed; ~1.0s; counterexamples cover all caller/side/seed/stake combinations including `player1 == player2 == keeper`. (PROJECT:BUNNYBAGZ) (2026-05-03)
