...
|---|---|---|
| `SOUL.md` | Uses `<see-env>` placeholders for secrets. Contains "Granus Labs" org name. | Keep if org name is intentionally public; otherwise add `<operator-org>` placeholder |
