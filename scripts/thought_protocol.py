...
Usage:
    from thought_protocol import thought, ThoughtFrame
...
# Register default decision patterns
thought.register_pattern("urgent_task", [
...
thought.register_pattern("risky_action", [
...
thought.register_pattern("memory_retrieval", [
