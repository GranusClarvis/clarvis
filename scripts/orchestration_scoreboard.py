...
Usage:
    python3 orchestration_scoreboard.py record   # append snapshot
    python3 orchestration_scoreboard.py show      # print latest scores
    python3 orchestration_scoreboard.py trend [n] # show last N snapshots
"""
