...
run_step "reflection_loop" python3 /home/agent/.openclaw/workspace/scripts/cognition/clarvis_reflection.py

# Step 3: Knowledge synthesis — cross-domain connections
run_step "knowledge_synthesis" python3 /home/agent/.openclaw/workspace/scripts/cognition/knowledge_synthesis.py
...
run_step "intra_linker" python3 /home/agent/.openclaw/workspace/scripts/hooks/intra_linker.py --cap 5

# Step 3.7: Semantic bridge building (cap 5/run)
# semantic_bridge_builder.py was removed; skip this step.
# run_step "semantic_bridge" python3 /home/agent/.openclaw/workspace/scripts/hooks/semantic_bridge_builder.py --top 2

# Step 4: Memory consolidation — deduplicate, prune noise, archive stale
run_step "memory_consolidation" python3 /home/agent/.openclaw/workspace/scripts/brain_mem/memory_consolidation.py consolidate

# Step 4.5: Hebbian memory evolution (A-Mem style)
run_step "hebbian_evolve" python3 /home/agent/.openclaw/workspace/scripts/brain_mem/hebbian_memory.py evolve

# Step 4.6: Synaptic memory evolution — STDP weight updates + consolidation
run_step "synaptic_evolve" python3 /home/agent/.openclaw/workspace/scripts/brain_mem/synaptic_memory.py evolve
run_step "synaptic_consolidate" python3 /home/agent/.openclaw/workspace/scripts/brain_mem/synaptic_memory.py consolidate

# Step 5: Conversation learning
run_step "conversation_learner" python3 /home/agent/.openclaw/workspace/scripts/cognition/conversation_learner.py

# Step 5.5: Failure amplification — surface soft failures as negative episodes
run_step "failure_amplifier" python3 /home/agent/.openclaw/workspace/scripts/evolution/failure_amplifier.py amplify

# Step 6: Episodic synthesis
run_step "episodic_synthesis" python3 /home/agent/.openclaw/workspace/scripts/brain_mem/episodic_memory.py synthesize

# Step 6.5: Temporal self-awareness
run_step "temporal_self" python3 /home/agent/.openclaw/workspace/scripts/hooks/temporal_self.py store

# Step 6.7: Meta-learning analysis
run_step "meta_learning" python3 /home/agent/.openclaw/workspace/scripts/evolution/meta_learning.py analyze

# Step 6.9: Absolute Zero Reasoner (AZR)
run_step "absolute_zero" python3 /home/agent/.openclaw/workspace/scripts/cognition/absolute_zero.py run 3

# Step 6.95: Causal Analysis (Pearl SCM)
run_step "causal_model" python3 /home/agent/.openclaw/workspace/scripts/cognition/causal_model.py analyze
...
if [ "$DAY_OF_MONTH" = "01" ]; then
    run_step "research_bridge" python3 /home/agent/.openclaw/workspace/scripts/evolution/research_to_queue.py inject --max 3
fi

# Step 7: Session close — save attention state and working memory for next session — CRITICAL
run_step "session_close" python3 /home/agent/.openclaw/workspace/scripts/hooks/session_hook.py close
