...
ALL_COLLECTIONS = [IDENTITY, PREFERENCES, LEARNINGS, INFRASTRUCTURE, GOALS, CONTEXT, MEMORIES, PROCEDURES, AUTONOMOUS_LEARNING]
# Fast defaults - excludes identity/infra (rarely needed in queries)
DEFAULT_COLLECTIONS = [LEARNINGS, MEMORIES, GOALS, CONTEXT, PREFERENCES, AUTONOMOUS_LEARNING]
